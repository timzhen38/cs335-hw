...
class HashTableQuadratic {
 public:
  ...
  //returns the number of items inside the hash
  int getNumItems()
  {
 ...
 private:        
  ...
  //mutable means that you can alter a private data member inside a const function
  mutable int num_collisions = 0; // number of collisions
